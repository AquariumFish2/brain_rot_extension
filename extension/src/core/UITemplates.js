...
export function getDropdownHTML() {
    ...
    const buildOptions = (keys) => keys.map(k => `
 ...
 */
export function getDiffCardHTML(id, name, meta) {
    return `
 ...
 */
export function getScoreBoxHTML(id, label) {
    return `
 ...
 */
export function getMainOverlayHTML() {
    return `
    <div class="app">
